...
mock.onGet('/api/academy-app/categories').reply(() => [200, academyDB.categories]);

mock.onGet('/api/academy-app/courses').reply(() => [200, academyDB.courses.map((_course) => _.omit(_course, ['steps']))]);
