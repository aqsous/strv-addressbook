...
mock.onGet('/api/project-dashboard-app/widgets').reply((config) => [200, projectDashboardAppDB.widgets]);

mock.onGet('/api/project-dashboard-app/projects').reply((config) => [200, projectDashboardAppDB.projects]);
