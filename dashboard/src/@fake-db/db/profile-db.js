...
mock.onGet('/api/profile/timeline').reply((config) => [200, profileDB.timeline]);

mock.onGet('/api/profile/photos-videos').reply((config) => [200, profileDB.photosVideos]);

mock.onGet('/api/profile/about').reply((config) => [200, profileDB.about]);
