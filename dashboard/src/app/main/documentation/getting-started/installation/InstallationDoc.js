    ...
    <>
      ...
      <div className="my-24 px-12 py-8 border-1 border-red rounded-8">
        ...
        <Typography className="" component="div">
          ...
          {' '}
          After running
          <code>yarn set version berry</code>
          <br />
          This line:
      ...
      <Typography className="my-16" component="div">
        <ol>
          <li className="mb-16">
            ...
            {' '}
            <b>(Fuse-react-x.x.x-skeleton.zip)</b>
            {' '}
            along with the Demo Project
            {' '}
            <b>(Fuse-react-x.x.x-demo.zip)</b>
