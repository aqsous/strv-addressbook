...
function ThemeLayoutsDoc() {
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        These layouts are accessible from
        {' '}
        <code>/src/app/fuse-layouts</code>
        {' '}
        directory and you can modify them
      ...
      <Typography className="my-16" component="div">
        ...
        <ul className="my-8 list-disc ml-16">
          <li className="mb-8">
            ...
            <ul className="my-8 ml-12">
              <li className="mb-8">
                <b>/components</b>
                {' '}
                : Contains Layout elements such as Toolbar, Footer, and Navbar.
      </li>
              <li className="mb-8">
                <b>/Layout1.js</b>
                {' '}
              ...
              <li className="mb-8">
                <b>/Layout1.config.js</b>
                {' '}
                : Contains title, default configs and form options of the
                layout.
      </li>
            </ul>
          </li>
          <li className="mb-8">
            ...
            {' '}
            : Each layouts shares the components of this directory
          </li>
          <li className="mb-8">
            <b>/FuseLayoutConfigs.js</b>
            {' '}
            : Imports all layout configs.
          </li>
          <li className="mb-8">
            <b>/FuseLayouts.js</b>
            {' '}
            : Imports all layout components.
          </li>
          <li className="mb-8">
            <b>/layout-2</b>
          </li>
