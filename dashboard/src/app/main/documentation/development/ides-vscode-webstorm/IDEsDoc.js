  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        If you are using IntelliJ/WebStorm, you should use
        {' '}
        <b>v2020.1+</b>
        {' '}
        for to use Yarn 2 with PnP.
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        We are using ESLint with
        {' '}
        <b>eslint-plugin-prettier</b>
        . You should use the
        <b>Fix ESLint Problems</b>
        {' '}
        action to reformat the current file/folder – find it using Find Action (Cmd/Ctrl-Shift-A) or add a
        keyboard shortcut to it in
        {' '}
        <b>Preferences | Keymap</b>
        {' '}
        and then use it. Make sure that the
        {' '}
        <b>ESLint integration</b>
        {' '}
        is enabled in
        {' '}
      ...
      <Typography className="mb-16" component="p">
        ...
        <b>Prettier</b>
        {' '}
        plugins - can be installed using the extension
        sidebar in VSCode
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        ...
        <b>settings.json</b>
        {' '}
        configuration. With this configuration, fixes will be applied
