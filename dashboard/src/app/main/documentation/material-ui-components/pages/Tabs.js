...
function TabsDoc(props) {
  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        Long labels will automatically wrap on tabs. If the label is too long for the tab, it will overflow and the text will not be
        visible.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <Typography className="mb-16" component="div">
        Left and right scroll buttons will never be presented. All scrolling must be initiated through user agent scrolling mechanisms (e.g.
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>button</code>
        {' '}
        element, but you can provide your own custom tag or component. Here&#39;s an example of
      ...
      <Typography className="mb-16" component="div">
        (WAI-ARIA:
        <a href="https://www.w3.org/TR/wai-aria-practices/#tabpanel">https://www.w3.org/TR/wai-aria-practices/#tabpanel</a>
        )
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="#experimental-api">
          an
          experimental API
        </a>
        {' '}
        in
        <code>@material-ui/lab</code>
        {' '}
      ...
      <Typography className="mb-16" component="div">
        ...
        &quot;selection automatically follows focus&quot; behavior you have pass
        <code>selectionFollowsFocus</code>
        {' '}
        to the
        <code>Tabs</code>
        {' '}
        component. The WAI-ARIA authoring practices
        have a detailed guide on
        <a href="https://www.w3.org/TR/wai-aria-practices/#kbd_selection_follows_focus">
          how to decide when to make selection automatically follow
          focus
        </a>
        .
      </Typography>
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        following
        {' '}
        <a href="https://www.w3.org/TR/wai-aria-practices/#tabpanel">WAI-ARIA authoring practices</a>
        .
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
