  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/system/basics/#all-inclusive">all the style functions</a>
        {' '}
        that are exposed
        in
        <code>@material-ui/system</code>
        .
        It&#39;s created using the
        <a href="/styles/api/#styled-style-function-component"><code>styled()</code></a>
        {' '}
        function of
        <code>@material-ui/core/styles</code>
        .
      </Typography>
      <Typography className="text-32 mt-32 mb-8" component="h2">Example</Typography>
      <Typography className="mb-16" component="div">
        <a href="/system/palette/">The palette</a>
        {' '}
        style function.
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>{'<div>'}</code>
        {' '}
        by default that can be changed with the
        <code>component</code>
        {' '}
        property.
...
`}
      ...
      <ol>
        <li>
          Use
          <a href="https://reactjs.org/docs/react-api.html#cloneelement"><code>React.cloneElement()</code></a>
        </li>
      </ol>
      <Typography className="mb-16" component="div">
        The Box component has a
        <code>clone</code>
        {' '}
        property to enable the usage of the clone element method of React.
      </Typography>
...
&nbsp;func
          ...
          <tr>
            ...
            <td align="left">
              If
              <code>true</code>
              , the box will recycle its children DOM element. It&#39;s using
...
&nbsp;object
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/system/basics/#all-inclusive">the style functions</a>
        {' '}
        or spread to the root
        element.
      </Typography>
