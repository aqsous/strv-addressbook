  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/selection-controls.html#checkboxes">Checkboxes</a>
        {' '}
        can be used to turn an option on or
        off.
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        (WAI-ARIA:
        <a href="https://www.w3.org/TR/wai-aria-practices/#checkbox">https://www.w3.org/TR/wai-aria-practices/#checkbox</a>
        )
      </Typography>
      <ul>
        <li>
