  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/progress-indicators.html">Progress indicators</a>
        {' '}
        inform users about the status of ongoing
      ...
      <ul>
        <li>
          ...
          {' '}
          indicators display how long an operation will take.
        </li>
        <li>
      ...
      <Typography className="mb-16" component="div">
        The progress components accept a value in the range 0 - 100. This simplifies things for screen-reader users, where these are the default min /
...
`}
      ...
      <Typography className="mb-16" component="div">
        There are
        <a href="https://www.nngroup.com/articles/response-times-3-important-limits/">3 important limits</a>
        {' '}
        to know around response time.
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>disableShrink</code>
        {' '}
        property to mitigate the issue.
        See
