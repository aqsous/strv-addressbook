  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/api/typography/">Typography</a>
        {' '}
        component.
      ...
      <ul>
        <li>
          <code>rel="noopener"</code>
          {' '}
          prevents the new page from being able to access the
          {' '}
        ...
        <li>
          <code>rel="noreferrer"</code>
          {' '}
          has the same effect, but also prevents the
          {' '}
          <em>Referer</em>
          {' '}
      ...
      <Typography className="mb-16" component="div">
        Here is an
        <a href="/guides/composition/#link">integration example with react-router</a>
        .
      </Typography>
      ...
      <ul>
        <li>
          ...
          Instead, use
          <a href="https://developers.google.com/web/tools/lighthouse/audits/descriptive-link-text">specific descriptions</a>
          .
        </li>
