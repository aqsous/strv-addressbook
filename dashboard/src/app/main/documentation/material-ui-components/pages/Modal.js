    ...
    <>
      ...
      <blockquote>
        <Typography className="mb-16" component="div">
          ...
          An element is considered modal if
          {' '}
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        component rather than directly
        using Modal.
      ...
      <ul>
        ...
        <li>
          ...
          <code>in</code>
          {' '}
          prop. This corresponds to the open / close state.
        </li>
        <li>
          Call the
          <code>onEnter</code>
          {' '}
          callback prop when the enter transition starts.
        </li>
        <li>
          Call the
          <code>onExited</code>
      ...
      <Typography className="mb-16" component="div">
        React
        <a href="https://github.com/facebook/react/issues/13097">doesn&#39;t support</a>
        {' '}
        the
        <a
        ...
        {' '}
        API on the server.
        In order to display the modal, you need to disable the portal feature with the
      ...
      <ul>
        <li>
          <Typography className="mb-16" component="div">
            ...
            , referencing the modal title, to the
            <code>Modal</code>
            .
            Additionally, you may give a description of your modal with the
            <code>aria-describedby="id..."</code>
            {' '}
            prop on the
            <code>Modal</code>
            .
...
`}
        ...
        <li>
          <Typography className="mb-16" component="div">
            The
            <a href="https://www.w3.org/TR/wai-aria-practices/examples/dialog-modal/dialog.html">WAI-ARIA authoring practices</a>
            {' '}
            can help you
            set the initial focus on the most relevant element, based on your modal content.
          </Typography>
        </li>
        <li>
          <Typography className="mb-16" component="div">
            Keep in mind that a &quot;modal window&quot; overlays on either the primary window or another modal window. Windows under a modal
            are
            <strong>inert</strong>
            . That is, users cannot interact with content outside an active modal window. This might create
            <a href="#focus-trap">
              conflicting
              behaviors
            </a>
