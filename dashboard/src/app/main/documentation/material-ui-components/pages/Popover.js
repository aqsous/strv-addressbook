    ...
    <>
      ...
      <ul>
        <li>
          ...
          <a href="/components/modal/"><code>Modal</code></a>
          {' '}
          component.
        </li>
        <li>
          The scroll and click away are blocked unlike with the
          <a href="/components/popper/"><code>Popper</code></a>
          {' '}
          component.
        </li>
      </ul>
      ...
      <Typography className="mb-16" component="div">
        Use the radio buttons to adjust the
        ...
        <code>anchorReference</code>
        {' '}
        to
        <code>anchorPosition</code>
        {' '}
        or
        <code>anchorEl</code>
        .
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>Popover</code>
        {' '}
        component to implement a popover behavior based on the mouse over
        event.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
