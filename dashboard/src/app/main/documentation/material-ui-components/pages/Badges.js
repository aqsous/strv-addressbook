  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>max</code>
        {' '}
        property to cap the value of the badge content.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>dot</code>
        {' '}
        property changes a badge into a small dot. This can be used as a notification that something has changed without
        giving a count.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
