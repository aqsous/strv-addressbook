  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/archive/guidelines/components/expansion-panels.html">An accordion</a>
        {' '}
        is a lightweight container that may either
        stand alone or be connected to a larger surface, such as a card.
      </Typography>
      <blockquote>
        <Typography className="mb-16" component="div">
          <strong>Note:</strong>
          ...
          , but
          Material-UI will continue to support them. It was formerly known as the &quot;expansion panel&quot;.
        </Typography>
      </blockquote>
      ...
      <Typography className="mb-16" component="div">
        In order to put an action such as a
        <code>Checkbox</code>
        {' '}
        or a button inside of the
        <code>AccordionSummary</code>
        , you need to stop
        ...
        {' '}
        for the action, otherwise the label of the nested action will be included in
...
`}
      ...
      <Typography className="mb-16" component="div">
        For optimal accessibility we recommend setting
        <code>id</code>
        {' '}
        and
