  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        A
        <a href="https://material.io/design/components/buttons-floating-action-button.html">floating action button</a>
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>size</code>
        {' '}
        prop for larger or smaller floating action buttons.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
