  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        A
        <a href="https://material.io/design/typography/#type-scale">typographic scale</a>
        {' '}
        has a limited set of type sizes that work well together along with the layout grid.
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        ...
        <strong>not</strong>
        {' '}
        be automatically loaded by Material-UI.
...
`}
      ...
      <Typography className="mb-16" component="div">
        You can
        <a href="https://www.npmjs.com/package/fontsource-roboto">install it</a>
        {' '}
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        <a
          href="https://github.com/DecliningLotus/fontsource/blob/master/packages/roboto/README.md"
        >
          Fontsource
        </a>
        .
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/customization/default-theme/?expand-path=$.typography"><code>typography</code></a>
        {' '}
        keys of the theme.
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        The Typography component uses the
        <code>variantMapping</code>
        {' '}
        property to associate a UI variant with a semantic element.
...
`}
      ...
      <ul>
        <li>
          <strong>Color</strong>
          . Provide enough contrast between text and its background, check out the minimum recommended
          {' '}
          <a
        ...
        <li>
          ...
          . Use
          {' '}
          <a href="/customization/typography/#font-size">relative units (rem)</a>
          {' '}
        ...
        <li>
          ...
          {' '}
          heading levels. In order to solve this problem, you need
          to
          {' '}
