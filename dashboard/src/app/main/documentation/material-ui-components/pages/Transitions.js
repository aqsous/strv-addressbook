...
`}
      ...
      <Typography className="mb-16" component="div">
        The Transition component&#39;s
        <code>mountOnEnter</code>
        {' '}
        ...
        from it&#39;s off-screen position. Similarly the
      ...
      <Typography className="mb-16" component="div">
        The components accept a
        <code>TransitionComponent</code>
        {' '}
        prop to customize the default transitions.
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="http://reactcommunity.org/react-transition-group/transition">
          React
          Transition Group Transition docs
        </a>
        .
      </Typography>
