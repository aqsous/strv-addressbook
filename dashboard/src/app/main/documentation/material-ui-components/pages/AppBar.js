  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        The
        <a href="https://material.io/design/components/app-bars-top.html">top App Bar</a>
        {' '}
        provides content and actions related to the current
      ...
      <Typography className="mb-16" component="div">
        When you render the app bar position fixed, the dimension of the element doesn&#39;t impact the rest of the page. This can cause some part of
        your content to be invisible, behind the app bar. Here are 3 possible solutions:
      </Typography>
      <ol>
        <li>
          You can use
          ...
          {' '}
          instead of fixed. ⚠️ sticky is not supported by IE 11.
        </li>
        <li>
          You can render a second
          <code>{'<Toolbar />'}</code>
          {' '}
          component:
        </li>
...
`}
      ...
      <ol start="3">
        <li>
          You can use
          <code>theme.mixins.toolbar</code>
          {' '}
          CSS:
        </li>
      </ol>
...
`}
      ...
      <ol>
        <li>
          ...
          <ul>
            <li>
              <code>options.disableHysteresis</code>
              {' '}
              (
              <em>Boolean</em>
              {' '}
              ...
              {' '}
              <code>false</code>
              . Disable the hysteresis. Ignore the scroll direction when
              determining the
              {' '}
              <code>trigger</code>
              {' '}
            ...
            <li>
              ...
              <code>trigger</code>
              {' '}
              value when the vertical scroll
