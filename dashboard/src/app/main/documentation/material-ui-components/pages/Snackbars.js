  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/snackbars.html">Snackbars</a>
        {' '}
        inform users of a process that an app has performed or will
        perform. They appear temporarily, towards the bottom of the screen. They shouldn’t interrupt the user experience, and they don’t require user input to disappear.
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        ...
        You can control the position of the snackbar by specifying the
        <code>anchorOrigin</code>
        {' '}
        prop.
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        <a href="/components/transitions/#grow">Grow</a>
        {' '}
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/components/transitions/#slide">Slide</a>
        {' '}
        transition.
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        ...
        .
        notistack has an
        <strong>imperative API</strong>
        {' '}
        that makes it easy to display snackbars, without having to handle their open/close state.
        It also enables you to
        <strong>stack</strong>
        {' '}
        them on top of one another (although this is discouraged by the Material Design specification).
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        (WAI-ARIA:
        <a href="https://www.w3.org/TR/wai-aria-1.1/#alert">https://www.w3.org/TR/wai-aria-1.1/#alert</a>
        )
      </Typography>
      <ul>
        <li>
          ...
          <a
            href="https://www.w3.org/TR/UNDERSTANDING-WCAG20/time-limits.html"
          >
            sufficient time
</a>
          {' '}
