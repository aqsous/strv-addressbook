  ...
  return (
    ...
    <>
      ...
      <ol>
        ...
        <li>
          The textbox may contain any arbitrary value, but it is advantageous to suggest possible values to the user, e.g., a search field may suggest similar or previous searches to save
          the user time:
      ...
      <ol>
        <li>
          ...
          <code>onChange</code>
          {' '}
          props combination. This state represents the value selected by the user, for instance when
          pressing
          <kbd>Enter</kbd>
          .
        </li>
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        with suggestions, e.g. Google search or
        react-autowhatever.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <Typography className="mb-16" component="div">
        If you intend to use this mode for a
        <a href="#combo-box">combo box</a>
        {' '}
      ...
      <ul>
        <li>
          ...
          {' '}
          to helps the user clear the selected value.
        </li>
        <li>
          <code>clearOnBlur</code>
          {' '}
          to helps the user to enter a new value.
        </li>
        <li>
          <code>handleHomeEndKeys</code>
          {' '}
          to move focus inside the popup with the
          {' '}
          <kbd>Home</kbd>
          {' '}
          and
        ...
        <li>
          A last option, for instance
          <code>Add "YOUR SEARCH"</code>
          .
        </li>
      </ul>
      <Typography className="mb-16" component="div">
...
`}
      ...
      <Typography className="mb-16" component="div">
        Head to the
        <a href="#customized-autocomplete">Customized Autocomplete</a>
        {' '}
        section for a customization example with
        the
      ...
      <Typography className="mb-16" component="div">
        In the event that you need to lock certain tag so that they can&#39;t be removed in the interface, you can set the chips
        disabled.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <Typography className="mb-16" component="div">
        Head to the
        <a href="#customized-hook">Customized hook</a>
        {' '}
        section for a customization example with the
        <code>useAutocomplete</code>
        {' '}
        hook
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="https://github.com/moroshko/autosuggest-highlight">autosuggest-highlight</a>
        , a small (1 kB) utility for
        highlighting text in autosuggest and autocomplete components.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
...
`}
      ...
      <ol>
        <li>
          ...
          <ul>
            <li>
              <code>config.ignoreAccents</code>
              {' '}
              (
              <em>Boolean</em>
              {' '}
            ...
            <li>
              <code>config.limit</code>
              {' '}
              (
              <em>Number</em>
              {' '}
              [optional]): Default to null. Limit the number of suggested options to be shown. For example,
              if
              {' '}
              <code>config.limit</code>
              {' '}
              ...
              <code>100</code>
              {' '}
              matching options are shown. It can be useful if a lot of options match and
            ...
            <li>
              <code>config.stringify</code>
              {' '}
              (
              <em>Func</em>
              {' '}
              [optional]): Controls how an option is converted into a string so that it can be matched against the input text fragment.
            </li>
            <li>
              <code>config.trim</code>
              {' '}
              (
              <em>Boolean</em>
              {' '}
      ...
      <Typography className="mb-16" component="div">
        <code>filterOptions</code>
        : the returned filter method can be provided directly to the
        {' '}
        <code>filterOptions</code>
        {' '}
        prop of
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        attribute very well.
        You can work around the issue with the
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>ListboxComponent</code>
        {' '}
        prop, you need to make sure that the intended scroll container has
        the
        <code>role</code>
        {' '}
        attribute set to
      ...
      <Typography className="mb-16" component="div">
        (WAI-ARIA:
        <a href="https://www.w3.org/TR/wai-aria-practices/#combobox">https://www.w3.org/TR/wai-aria-practices/#combobox</a>
        )
      </Typography>
      <Typography className="mb-16" component="div">
