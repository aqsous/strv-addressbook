  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>maxWidth</code>
        {' '}
        enumerable in combination with
        the
        <code>fullWidth</code>
        {' '}
        boolean.
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/components/use-media-query/#usemediaquery"><code>useMediaQuery</code></a>
        .
      </Typography>
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="https://github.com/mzabriskie/react-draggable">react-draggable</a>
        .
        To do so, you can pass the the imported
        <code>Draggable</code>
        {' '}
        component as the
        <code>PaperComponent</code>
        {' '}
        of the
        <code>Dialog</code>
        {' '}
      ...
      <Typography className="mb-16" component="div">
        Follow the
        <a href="/components/modal/#accessibility">Modal accessibility section</a>
        .
      </Typography>
