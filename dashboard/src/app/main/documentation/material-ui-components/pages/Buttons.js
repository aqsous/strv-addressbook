...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/guides/api/#native-properties">avoids</a>
        {' '}
        mentioning native props (there are a lot) in the API section
        of the components.
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        Fancy larger or smaller buttons? Use the
        <code>size</code>
        {' '}
        property.
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        Sometimes you might want to have icons for certain button to enhance the UX of the application as we recognize logos more easily than plain
        text. For example, if you have a delete button you can label it with a dustbin icon.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        The Text Buttons, Contained Buttons, Floating Action Buttons and Icon Buttons are built on top of the same component:
        the
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>ButtonBase</code>
        {' '}
        component provides a property to handle this use case:
        <code>component</code>
        .
        However for certain focus polyfills
        <code>ButtonBase</code>
        {' '}
        ...
        Given that many of the interactive components rely on
        <code>ButtonBase</code>
        , you should be
      ...
      <Typography className="mb-16" component="div">
        Here is an
        <a href="/guides/composition/#button">integration example with react-router</a>
        .
      </Typography>
      ...
      <ol>
        <li>
          <Typography className="mb-16" component="div">
            ...
            . You can remove the pointer events style on the disabled state of
            the
            {' '}
            <code>{'<button>'}</code>
            {' '}
