  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/text-fields.html">Text fields</a>
        {' '}
        allow users to enter text into a UI. They typically appear in
        forms and dialogs.
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>helperText</code>
        {' '}
        prop can then be used to provide feedback to the user
        about the error.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/components/selects/">Select</a>
        {' '}
      ...
      <Typography className="mb-16" component="div">
        <code>margin</code>
        {' '}
        prop can be used to alter the vertical spacing of inputs.
        Using
        {' '}
        <code>none</code>
        {' '}
      ...
      <Typography className="mb-16" component="div">
        ...
        ,
        and
        <a href="/api/form-helper-text/"><code>FormHelperText</code></a>
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/api/input-base/"><code>InputBase</code></a>
        {' '}
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="https://github.com/text-mask/text-mask">react-text-mask</a>
        {' '}
        and
        <a
        ...
        <a
          href="https://github.com/mui-org/material-ui/issues/16037"
        >
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        <strong>the input should be linked to the label and the helper text</strong>
        . The underlying DOM
        nodes should have this structure:
      </Typography>
