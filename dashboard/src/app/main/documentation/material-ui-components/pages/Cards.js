  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        are surfaces that display content and actions on a single
        topic.
      </Typography>
      <Typography className="mb-16" component="div">
        They should be easy to scan for relevant and actionable information. Elements, like text and images, should be placed on them in a way that
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        to display the media. It can be
        problematic in some situations. For instance, you might want to display a video or a responsive image. Use the
        <code>component</code>
        {' '}
      ...
      <blockquote>
        <Typography className="mb-16" component="div">
          ⚠️ When
          <code>component="img"</code>
          , CardMedia relies on
          <code>object-fit</code>
          {' '}
          for centering the image. It&#39;s not supported
          by IE 11.
        </Typography>
      </blockquote>
      <Typography className="text-32 mt-32 mb-8" component="h2">UI Controls</Typography>
      <Typography className="mb-16" component="div">
        Supplemental actions within the card are explicitly called out using icons, text, and UI controls, typically placed at the bottom of the
        card.
      </Typography>
