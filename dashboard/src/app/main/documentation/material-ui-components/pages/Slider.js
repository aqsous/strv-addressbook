  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        single value. They are ideal for adjusting settings such as volume, brightness, or applying image filters.
      </Typography>
      <ul>
        <li>
          📦
          <a href="/size-snapshot">22 kB gzipped</a>
          {' '}
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/customization/components/">
          overrides
          documentation page
        </a>
        .
      ...
      <Typography className="mb-16" component="div">
        ...
        For instance, in the following demo, the value
        <em>x</em>
        {' '}
