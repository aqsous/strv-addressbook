    ...
    <>
      ...
      <ul>
        ...
        <li>
          ...
          {' '}
          (
          <a href="https://bundlephobia.com/result?p=popper.js">7 kB</a>
          {' '}
          from Popper.js).
        </li>
        <li>
          The children is
          <a href="/components/portal/"><code>Portal</code></a>
          {' '}
          to the body of the document to avoid rendering problems.
        ...
        <li>
          ...
          <a href="/components/popover/"><code>Popover</code></a>
          {' '}
          component.
        ...
        <li>
          ...
          {' '}
          component.
          If you need this behavior, you can use
          <a href="/components/click-away-listener/"><code>ClickAwayListener</code></a>
          {' '}
          - see the example in the
          <a
            href="/components/menus/#menulist-composition"
          >
        ...
        <li>
          ...
          <code>anchorEl</code>
          {' '}
          is passed as the reference object to create a new
          <code>Popper.js</code>
          {' '}
          instance.
        </li>
      ...
      <Typography className="mb-16" component="div">
        ...
        You just need to create an object shaped like the
        <a
          href="https://github.com/FezVrasta/popper.js/blob/0642ce0ddeffe3c7c033a412d4d60ce7ec8193c3/packages/popper/index.d.ts#L118-L123"
        >
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="https://github.com/jcoreio/material-ui-popup-state"><code>material-ui-popup-state</code></a>
        {' '}
        that
