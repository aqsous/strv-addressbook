  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        represent a collection of items in a repeated pattern. They
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>GridListTileBar</code>
        {' '}
        to add an overlay to each
        <code>GridListTile</code>
        .
        ...
        <code>subtitle</code>
        {' '}
        and secondary action - in this example an
