  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        Menus are positioned over their emitting elements such that the currently selected menu item appears on top of the emitting
        element.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <Typography className="mb-16" component="div">
        If you are looking for more advanced features, like combobox, multiselect, autocomplete, async or creatable support, head to the
        <a
      ...
      <Typography className="mb-16" component="div">
        ...
        You can find an example with the select mode
...
`}
      ...
      <Typography className="mb-16" component="div">
        For a
        <a href="#native-select">native select</a>
