  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        <strong>they are explicitly hidden</strong>
        .
        To ease integration with Material-UI&#39;s
        <a href="/customization/breakpoints/">responsive breakpoints</a>
        ,
        this component can be used to hide any content,
        or you can use it in conjunction with the
        <a href="/components/grid/"><code>Grid</code></a>
        {' '}
        component.
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        ...
        or
        <code>mdDown</code>
        , or one or more breakpoints
        e.g.
        <code>only='sm'</code>
        {' '}
        or
        <code>{'only={[\'md\', \'xl\']}'}</code>
        .
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>js</code>
        {' '}
        implementation is used, responsively hiding content based on using the
        <a
          href="/customization/breakpoints/#withwidth"
        >
          <code>withWidth()</code>
        </a>
        {' '}
        higher-order component that watches screen size.
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        if you don&#39;t want the browser to re-flow your
      ...
      <Typography className="mb-16" component="div">
        It is quite common to alter
        <code>Grid</code>
        {' '}
        at different responsive breakpoints, and in many cases, you want to hide some of those
        elements.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
