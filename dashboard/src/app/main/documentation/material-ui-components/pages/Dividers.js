  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/dividers.html">Dividers</a>
        {' '}
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        by default.
        You can save rendering this DOM element by using the
        <code>divider</code>
        {' '}
        property on the
        <code>ListItem</code>
      ...
      <Typography className="mb-16" component="div">
        In a list, you should ensure the
        <code>Divider</code>
        {' '}
        is rendered as an
        <code>{'<li>'}</code>
