  ...
  return (
    ...
    <>
      ...
      <Typography className="description">
        Navigation drawers provide access to destinations in your app. Side sheets are surfaces containing supplementary content that are anchored to the left
        or right edge of the screen.
      </Typography>

      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/navigation-drawer.html">Navigation drawers</a>
        {' '}
        (or &quot;sidebars&quot;) provide access to
        destinations and app functionality, such as switching accounts. They can either be permanently on-screen or controlled by a navigation menu icon.
      </Typography>
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/sheets-side.html">Side sheets</a>
        {' '}
        are supplementary surfaces primarily used on tablet and
        desktop.
      </Typography>
      <Typography className="text-32 mt-32 mb-8" component="h2">Temporary drawer</Typography>
      <Typography className="mb-16" component="div">
        Temporary navigation drawers can toggle open or closed. Closed by default, the drawer opens temporarily above all other content until a
        section is selected.
      </Typography>
      <Typography className="mb-16" component="div">
        The Drawer can be cancelled by clicking the overlay or pressing the Esc key.
        It closes when an item is selected, handled by controlling the
        <code>open</code>
        {' '}
        prop.
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        ...
        You can use the
        <code>disableBackdropTransition</code>
        {' '}
        property to help.
      </Typography>
      <Typography className="mb-16" component="div">
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>Hidden</code>
        {' '}
        responsive helper component allows showing different types of drawer depending on the screen width.
        A
        <code>temporary</code>
        {' '}
        drawer is shown for small screens while a
        <code>permanent</code>
        {' '}
      ...
      <Typography className="mb-16" component="div">
        When the drawer is outside of the page grid and opens, the drawer forces other content to change size and adapt to the smaller
        viewport.
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        Permanent navigation drawers are always visible and pinned to the left edge, at the same elevation as the content or background. They cannot
        be closed.
      </Typography>
      <Typography className="mb-16" component="div">
