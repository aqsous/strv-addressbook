  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        When activated,
        <a href="https://material.io/design/components/tooltips.html">Tooltips</a>
        {' '}
        display a text label identifying an element, such
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/guides/composition/#wrapping-components">wrapping components</a>
        {' '}
        guide.
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        will not activate
        on normal events like hover. To accommodate disabled elements, add a simple wrapper element, such as a
        <code>span</code>
        .
      </Typography>
      <blockquote>
      ...
      <blockquote>
        <Typography className="mb-16" component="div">
          ...
          <code>{'<button>'}</code>
          {' '}
          element, you should also add the CSS property
          <em>pointer-events: none;</em>
          {' '}
...
`}
      ...
      <Typography className="mb-16" component="div">
        The tooltip is normally shown immediately when the user&#39;s mouse hovers over the element, and hides immediately when the user&#39;s mouse
        leaves. A delay in showing or hiding the tooltip can be added through the properties
        <code>enterDelay</code>
        {' '}
        and
        <code>leaveDelay</code>
        , as shown in the Controlled Tooltips
        demo above.
      </Typography>
      <Typography className="mb-16" component="div">
        On mobile, the tooltip is displayed when the user longpresses the element and hides after a delay of 1500ms. You can disable this feature with
        the
        <code>disableTouchListener</code>
        {' '}
        property.
      </Typography>
      <Typography className="mb-16" component="div">
