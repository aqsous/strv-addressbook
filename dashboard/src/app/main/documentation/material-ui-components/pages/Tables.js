  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/data-tables.html">Tables</a>
        {' '}
        display information in a way that’s easy to scan, so that users
        can look for patterns and insights. They can be embedded in primary content, such as cards.
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        is designed for use-cases that are focused around handling a
      ...
      <Typography className="mb-16" component="div">
        ...
        . It
        uses the
        <code>TableSortLabel</code>
        {' '}
        component to help style column headings.
      </Typography>
      <Typography className="mb-16" component="div">
        The Table has been given a fixed width to demonstrate horizontal scrolling. In order to prevent the pagination controls from scrolling, the
        TablePagination component is used outside of the Table. (The
        <a href="#custom-pagination-actions">&#39;Custom Table Pagination Action&#39; example</a>
        {' '}
        below shows the pagination within
        the TableFooter.)
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <ul>
        <li>
          <Typography className="mb-16" component="div">
            ...
            , each number will be used for the option&#39;s label and value.
          </Typography>
...
`}
        ...
        <li>
          <Typography className="mb-16" component="div">
            ...
            <code>label</code>
            {' '}
            keys will be used respectively for the value and label
            of the option (useful for language strings such as &#39;All&#39;).
          </Typography>
...
`}
      ...
      <Typography className="mb-16" component="div">
        The
        <code>ActionsComponent</code>
        {' '}
        prop of the
        <code>TablePagination</code>
        {' '}
      ...
      <Typography className="mb-16" component="div">
        ...
        It utilizes the
        <a href="/api/collapse/"><code>Collapse</code></a>
        {' '}
        component.
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        A caption functions like a heading for a table. Most screen readers announce the content of captions. Captions help users to find a table and
