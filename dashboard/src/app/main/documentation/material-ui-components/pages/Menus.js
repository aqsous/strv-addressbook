  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        A
        <a href="https://material.io/design/components/menus.html">Menu</a>
        {' '}
      ...
      <Typography className="mb-16" component="div">
        Simple menus open over the anchor element by default (this option can be changed via props). When close to a screen edge, simple menus
        vertically realign to make sure that all menu items are completely visible.
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        ...
        : In contrast to simple menus, simple dialogs can present additional detail related to the options available
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        property (from
        <a href="/api/list-item/">ListItem</a>
        ).
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>MenuList</code>
        {' '}
        component that you can compose, with
        <code>Popper</code>
        {' '}
        in this example.
      </Typography>
