  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        You can
        <strong>wait a screen frame</strong>
        {' '}
        with the
        <code>defer</code>
        {' '}
        property to render the children.
        React does
        <a href="https://reactjs.org/docs/strict-mode.html#detecting-unexpected-side-effects">2 commits</a>
        {' '}
        instead of 1.
      </Typography>
      <Typography className="mb-16" component="div">
