  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        , a collection of HTML element and attribute
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        It&#39;s possible to apply the baseline only to the children by using the
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>{'<body>'}</code>
        {' '}
        elements are updated to provide better page-wide defaults. More
        specifically:
      </Typography>
      <ul>
        ...
        <li>
          ...
          It&#39;s using
          <a href="/customization/default-theme/?expand-path=$.palette.background"><code>theme.palette.background.default</code></a>
          {' '}
          for standard devices and a white
      ...
      <ul>
        <li>
          ...
          You can learn more about the implications of changing the
          <code>{'<html>'}</code>
          {' '}
        ...
        <li>
          Set the
          <code>theme.typography.body2</code>
          {' '}
          style on the
          <code>{'<body>'}</code>
          {' '}
        ...
        <li>
          ...
          <code>theme.typography.fontWeightBold</code>
          {' '}
          for the
          <code>{'<b>'}</code>
          {' '}
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        section of the documentation to change the output of these
        components.
      </Typography>
