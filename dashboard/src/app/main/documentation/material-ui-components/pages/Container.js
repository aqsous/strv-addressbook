  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        A fluid container width is bounded by the
        <code>maxWidth</code>
        {' '}
        property value.
      </Typography>
...
`}
      ...
      <Typography className="mb-16" component="div">
        If you prefer to design for a fixed set of sizes instead of trying to accommodate a fully fluid viewport, you can set
        the
        <code>fixed</code>
        {' '}
        property.
