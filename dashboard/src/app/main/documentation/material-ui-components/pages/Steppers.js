  ...
  return (
    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        display progress through a sequence of logical and
      ...
      <ul>
        <li>
          ...
          : Editable, Non-editable, Mobile, Optional
        </li>
        <li>
      ...
      <blockquote>
        <Typography className="mb-16" component="div">
          <strong>Note:</strong>
          {' '}
          Steppers are no longer documented in the
          {' '}
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>Stepper</code>
        {' '}
        can be controlled by passing the current step index (zero-based) as
        the
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>Step</code>
        {' '}
        component. Note that it&#39;s up to you to manage when an optional step is skipped. Once you&#39;ve determined this for a particular step you must
        set
      ...
      <Typography className="mb-16" component="div">
        ...
        {' '}
        here demonstrates clickable step labels, as well as setting the
        <code>completed</code>
      ...
      <Typography className="mb-16" component="div">
        ...
        <a
          href="https://material.io/archive/guidelines/components/steppers.html#steppers-types-of-steps"
        >
          mobile steps
        </a>
        {' '}
      ...
      <Typography className="mb-16" component="div">
        Use a progress bar when there are many steps, or if there are steps that need to be inserted during the process (based on responses to earlier
        steps).
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
