    ...
    <>
      ...
      <ul>
        <li>
          ...
          <code>onClick</code>
          {' '}
          property defined change appearance on focus,
          hover, and click.
        </li>
        <li>
          Chips with the
          <code>onDelete</code>
          {' '}
          property defined will display a delete
      ...
      <Typography className="mb-16" component="div">
        If the Chip is deletable or clickable then it is a button in tab order. When the Chip is focused (e.g. when tabbing) releasing
        (
        <code>keyup</code>
        {' '}
        event)
