  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        <code>FuseNavigation</code>
        {' '}
        is a custom-built Fuse component that allows you to create a multi-level
      ...
      <Typography className="mb-16" component="p">
        <code>FuseNavigation</code>
        {' '}
        uses an array to populate the entire navigation. It supports four different
      ...
      <Typography className="mb-16" component="p">
        ...
        <b>active</b>
        {' '}
        to "square" to use square active item style instead of rounded/circle for
        {' '}
        <b>vertical layout</b>
        .
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        ...
        <b>{'dense={true}'}</b>
        {' '}
        to set dense variation of the navigation.
      </Typography>
      ...
      <Typography className="text-16 mb-8" component="h2">
        Use
        {' '}
        <code>removeNavigationItem(id)</code>
        {' '}
