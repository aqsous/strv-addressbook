  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        <code>FuseAuthorization</code>
        {' '}
        is the authorization component of the Fuse React. It restricts
      ...
      <Typography className="mb-16" component="p">
        ...
        <br />
        With this configuration below, makes
        {' '}
        <b>whole app</b>
        {' '}
      ...
      <Typography className="mb-16" component="p">
        ...
        <b>SET_USER_DATA</b>
        {' '}
        action you can set redirectUrl on
      </Typography>
