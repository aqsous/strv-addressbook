...
const changelogData = [
        ...
        >
          ...
          <ul className="list-disc ml-16">
            ...
            <li>
              ...
              <br />
              - createEntityAdapter function generates a set of prebuilt reducers and selectors for
  ...
  },
  {
    ...
    fixedChanges: [
      <span>
        <i>"createBrowserHistroy is not exported from history.js"</i>
        {' '}
    ...
    notes: (
      <Typography className="text-14 p-12 border-2 rounded-8 w-full max-w-lg mt-16" component="div">
        ...
        <b>v3.0.0</b>
        ) can be difficult because of the hooks support and
  ...
  },
  {
    ...
    newChanges: [
      ...
      <span>
        ...
        <b>Auth</b>
        {' '}
        component added as entry point for
        authentication.
      </span>,
  ...
  },
  {
    ...
    newChanges: [
      <span>
        <code>velocity-react</code>
        {' '}
        added as dependency, its used for fuseAnimation
      </span>,
      <span>
        <code>FuseAnimation</code>
        {' '}
        <code>FuseAnimationGroup</code>
        {' '}
        created for easily animate components and
