...
const getDisplayName = (user) => {
  ...
  // let displayName = '';
  // displayName += user.firstName.charAt(0)
  //   .toUpperCase();
  // displayName += user.firstName.slice(1);
  // displayName += ' ';
...
export const setUserData = (user) => async (dispatch, getState) => {
  ...
  const clearUserData = {
    ...
    data: {
      ...
      email: user.email,
      settings: user.dashboardSettings ? (user.dashboardSettings.settings || {}) : {},
      shortcuts: user.dashboardSettings ? (user.dashboardSettings.shortcuts || []) : [],
    },
  };
  ...
  /*
    Set User Settings
     */
  dispatch(setDefaultSettings(clearUserData.data.settings));
